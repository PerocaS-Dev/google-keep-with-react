...
const Form = (props) => {
  /*creating an event handler => the onClick listens for a click and then triggers function formClickHandler*/
  ...
  const submitFormHandler = (event) => {
    ...
    if (!edit) {
      props.addNote({
        ...
        title,
        text,
      }); //so here we are now calling that addNote funstion and pushing a note to it.
